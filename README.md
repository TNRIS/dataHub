...
Runs the app in the development mode using the production API (api.tnris.org).<br>
...
Runs the app in the development mode using a local/development instance of the API (localhost:8000).<br>
Open [http://localhost:3000](http://localhost:3000) to view it in the browser.
