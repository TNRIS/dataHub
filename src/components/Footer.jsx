...
export default class Footer extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={`footer-component ${drawerStatusClass}`}
        id="master-footer"
      >
          ...
          <li className="link-container-menu-list">
            <div className="mdc-menu-surface--anchor">
              ...
              <div ref="legal_link_menu" className="mdc-menu mdc-menu-surface">
                <ul
                  className="mdc-list inner-menu-link-list"
                  role="listbox"
                  aria-hidden="true"
                >
                  <a
                    className="mdc-list-item"
                    href="https://tnris.org/site-policies#privacy-and-security-policy"
                    target="_blank"
                  ...
                  <a
                    className="mdc-list-item"
                    href="https://tnris.org/site-policies#accessibility-policy"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
                  ...
                  <a
                    className="mdc-list-item"
                    href="http://www.twdb.texas.gov/home/open_records.asp"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
                  ...
                  <a
                    className="mdc-list-item"
                    href="http://www.twdb.texas.gov/home/compact_texan.asp"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
                  ...
                  <a
                    className="mdc-list-item"
                    href="http://www.twdb.texas.gov/home/fraud.asp"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
              ...
              <div ref="copyright_menu" className="mdc-menu mdc-menu-surface">
                ...
                >
                  <p className="nested-item">
                    ...
                    System and Texas Water Development Board unless otherwise
                    noted.
                  </p>
                  <button
            ...
            <div className="mdc-menu-surface--anchor">
              ...
              <div ref="tnris_link_menu" className="mdc-menu mdc-menu-surface">
                ...
                >
                  <a
                    className="mdc-list-item"
                    href="https://tnris.org/applications-and-utilities/"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
                  ...
                  <a
                    className="mdc-list-item"
                    href="https://tnris.org/geographic-information-office/"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
                  ...
                  <a
                    className="mdc-list-item"
                    href="https://tnris.org/research-distribution-center"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
                  ...
                  <a
                    className="mdc-list-item"
                    href="https://tnris.org/education/"
                    target="_blank"
                    rel="noopener noreferrer"
                    tabIndex="0"
                  >
