...
export default function collectionFilterMapReducer(state = initialState, action) {
  switch(action.type) {
    case SET_COLLECTION_FILTER_MAP_AOI:
      // Set the user defined aoi rectangle from the collection filter map
      return {
        ...state,
    ...
    case SET_COLLECTION_FILTER_MAP_CENTER:
      // Set the center x,y of the collection filter map
      return {
        ...state,
    ...
    case SET_COLLECTION_FILTER_MAP_FILTER:
      // Set the collection filter map filter
      return {
        ...state,
    ...
    case SET_COLLECTION_FILTER_MAP_ZOOM:
      // Set the zoom level of the collection filter map
      return {
        ...state,
