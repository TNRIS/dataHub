...
export function fetchHistorical(dispatch, getState, results) {
  const apiQuery = process.env.REACT_APP_API_URL + '/api/v1/historical/collections';
...
export function fetchCollections() {
  return (dispatch, getState) => {
    ...
    return fetch(process.env.REACT_APP_API_URL + '/api/v1/collections')
      .then(handleErrors)
      .then(res => res.json())
      .then(json => {
...
export function fetchCollectionResources(collectionId) {
  const apiQuery = process.env.REACT_APP_API_URL + '/api/v1/resources?collection_id=' + collectionId;
  return (dispatch, getState) => {
